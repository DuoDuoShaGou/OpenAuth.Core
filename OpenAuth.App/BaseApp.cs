...
namespace OpenAuth.App
{
    ...
    public class BaseApp<T> where T : Entity
    {
        ...
        //public BaseApp(IUnitWork unitWork, IRepository<Role> repository, IAuth auth)
        //{
        //    UnitWork = unitWork;
    ...
    public class ERPBaseApp<T> where T : ERPEntity
    {
        /// <summary>
        /// 用于普通的数据库操作
        /// </summary>
        /// <value>The repository.</value>
        protected IERPRepository<T> Repository;

        /// <summary>
        /// 用于事务操作
        /// </summary>
        /// <value>The unit work.</value>
        protected IERPUnitWork UnitWork;

        protected IAuth _auth;
        private IRepository<Role> repository;
        private IAuth auth;

        public ERPBaseApp(IERPUnitWork unitWork, IERPRepository<T> repository, IAuth auth)
        {
            UnitWork = unitWork;
            Repository = repository;
            _auth = auth;
        ...
        //public ERPBaseApp(IUnitWork unitWork, IRepository<Role> repository, IAuth auth)
        //{
        //    UnitWork = unitWork;
        //    this.repository = repository;
        //    this.auth = auth;
